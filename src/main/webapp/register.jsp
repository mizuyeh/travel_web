    ...
    <div class="register-box-body">
        ...
        <form action="${pageContext.request.contextPath}/user/register.do" method="post">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="全名" name="username" value="${user.username}">
            ...
            <div class="form-group has-feedback">
                <input type="password" class="form-control" id="repw"
                       placeholder="确认密码" name="repassword" onkeyup="validate()" value="${user.password}">
