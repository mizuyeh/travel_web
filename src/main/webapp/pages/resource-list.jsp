				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<table id="dataList"
							...
							<c:forEach items="${resourceList}" var="p">
								<tr>
									...
									<td>${p.permission }</td>
									<td>
										<c:if test="${p.available == true}">正常</c:if>
										<c:if test="${p.available == false}">锁定</c:if>
									</td>
									<td class="text-center">
										<a href="${pageContext.request.contextPath}/resource/findById.do?id=${p.id}" class="btn bg-olive btn-xs">详情</a>
										<a href="${pageContext.request.contextPath}/resource/delete.do?id=${p.id}" class="btn bg-olive btn-xs">删除权限</a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
