				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control" placeholder="出游人数"
							value="${order.travelerCount}" readonly="readonly">
					</div>
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveler" items="${order.travelers}">
							...
							<tr>
								<td>${traveler.travelerTypeStr}</td>
								<td><input type="text" size="10" value="${traveler.travelerName }"
									readonly="readonly"></td>
								<td><input type="text" size="10" value="${traveler.sex }"
									readonly="readonly"></td>
								<td><input type="text" size="20"
									value="${traveler.phoneNum }" readonly="readonly"></td>
								<td><input type="text" size="15"
									value="${traveler.credentialsTypeStr}" readonly="readonly"></td>
								<td><input type="text" size="28"
									value="${traveler.credentialsNum }" readonly="readonly"></td>
							</tr>
						</c:forEach>
