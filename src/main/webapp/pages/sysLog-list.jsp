						...
						<table id="dataList"
							...
							<tbody>
								<c:forEach items="${sysLogs}" var="syslog">
									<tr>
										<td word-break: break-all; word-wrap:break-word;><input name="ids" type="checkbox"></td>
										<td style="word-break: break-all; word-wrap:break-word;">${syslog.id}</td>
										<td >${syslog.visitTimeStr }</td>
										<td>${syslog.username }</td>
										<td style="word-break: break-all; word-wrap: break-word">${syslog.ip }</td>
										<td >${syslog.url}</td>
										<td style="word-break: break-all; word-wrap: break-word">${syslog.executionTime}毫秒</td>
										<td style="word-break: break-all; word-wrap: break-word">${syslog.method}</td>
									</tr>
								</c:forEach>
							</tbody>
